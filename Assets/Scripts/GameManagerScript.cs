    ...
    void spawnEnemy()
	{
        ...
        if (timerEnemy > 2)
        {
            ...
            do
            {
				...
				{
                    // scale life and speed with the time
                    int additionalEnemyLife = score / 1000;
                    float additionalEnemySpeed = score / 10000;

                    // create the enemy
                    EnemyBehaviour enemy = Instantiate(enemyPrefab, enemyPosition, transform.rotation).GetComponent<EnemyBehaviour>();
                    enemy.life += additionalEnemyLife;
                    enemy.moveSpeed += additionalEnemySpeed;
                    break;
                }
